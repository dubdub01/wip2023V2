 ...
 */
final class Version20231105134827 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, worker_id INT DEFAULT NULL, value INT DEFAULT NULL, INDEX IDX_D88926226B20BA36 (worker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rating ADD CONSTRAINT FK_D88926226B20BA36 FOREIGN KEY (worker_id) REFERENCES worker (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rating DROP FOREIGN KEY FK_D88926226B20BA36');
